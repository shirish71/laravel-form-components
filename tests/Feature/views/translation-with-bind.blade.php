@php
    $targetA = new \Shirish71\LaravelFormComponents\Tests\Feature\TranslatableModel;
    $targetA->setTranslations('input', ['nl' => 'hallo', 'en' => 'hello']);

    $targetB = new \Shirish71\LaravelFormComponents\Tests\Feature\TranslatableModel;
